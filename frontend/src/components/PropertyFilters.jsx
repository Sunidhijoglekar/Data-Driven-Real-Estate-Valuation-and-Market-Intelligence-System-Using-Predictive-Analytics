...
export default function PropertyFilters({ onSearch, cities = ["All", "Bangalore"] }) {
  ...
  // Auto-apply search whenever any filter state changes
  useEffect(() => {
  ...
  }, [search, city, amenity, manualAmenity, areaPreset, minArea, maxArea, agePreset, manualAge, budgetPreset, minBudget, maxBudget, bhk]);
    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 mb-8">
      <div className="flex items-center justify-between pb-4 border-b border-slate-100 mb-5">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="font-heading font-bold text-slate-900 text-sm">Multi-Criteria Search & Filter</h3>
