...
import {
  Gavel, Clock, XCircle, Trophy, ArrowRight, ArrowLeft, Ticket, Lock, Filter
} from 'lucide-react';
      ...
      {displayedList.length === 0 ? (
        <div className="bg-white rounded-3xl border border-slate-200 p-12 text-center space-y-3">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-blue-600 text-white text-xs font-bold rounded-xl shadow-lg mt-2 inline-block cursor-pointer"
          >
            Browse All Auctions
          </button>
        </div>
                ...
                <div className="p-5 pt-0">
                  {approved ? (
                    <button
                      ...
                      className="w-full py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-black text-xs uppercase tracking-wider rounded-xl shadow-md flex items-center justify-center gap-1.5 transition-all cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="w-full py-2.5 bg-amber-600 hover:bg-amber-700 text-white font-black text-xs uppercase tracking-wider rounded-xl shadow-md flex items-center justify-center gap-1.5 transition-all cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="w-full py-2.5 bg-amber-500 text-white font-bold text-xs rounded-xl flex items-center justify-center gap-1.5 cursor-pointer"
                    >
                    ...
                    <button
                      onClick={() => navigate(`/join-auction/${prop.id || auc.property_id}`)}
                      className="w-full py-2.5 bg-slate-900 text-white font-bold text-xs rounded-xl flex items-center justify-center gap-1.5 hover:bg-slate-800 transition-all cursor-pointer"
                    >
