...
export default function GoogleMapComponent({ property }) {
  const lat = property.lat || 19.0760;
  const lng = property.lng || 72.8777;

  // Nearby Points of Interest simulation
  const nearbyPois = [
    { type: 'School', name: 'Delhi Public School / St. Xavier International', dist: '0.8 km', icon: School, color: 'text-blue-600 bg-blue-50' },
