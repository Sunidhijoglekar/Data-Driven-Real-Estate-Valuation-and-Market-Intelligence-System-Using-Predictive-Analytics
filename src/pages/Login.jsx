...
import { Building2, ShieldCheck, UserCheck, Lock, Mail, ArrowRight, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="font-heading text-2xl font-extrabold text-slate-900 tracking-tight">
            RealEstate<span className="text-blue-600">.AI</span> Portal
          </h1>
          <p className="text-xs text-slate-500 max-w-xs mx-auto">
            Data-Driven Real Estate Valuation & Market Intelligence System
          </p>
        </div>
          ...
          <div className="pt-4 border-t border-slate-100">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                className="p-2 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-xl text-[11px] font-semibold text-center border border-blue-200/60"
              >
                Buyer Portal
              </button>
              <button
                ...
                className="p-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 rounded-xl text-[11px] font-semibold text-center border border-emerald-200/60"
              >
                Seller Portal
              </button>
              <button
                ...
                className="p-2 bg-purple-50 hover:bg-purple-100 text-purple-700 rounded-xl text-[11px] font-semibold text-center border border-purple-200/60"
              >
                Investor Portal
              </button>
            </div>
